 ...
 */
final class Version20250626163834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE modifier_tarif (id INT AUTO_INCREMENT NOT NULL, id_tarif_id INT NOT NULL, id_user_admin_id INT NOT NULL, date_modifier_tarif DATETIME NOT NULL, INDEX IDX_399C9EF765A7E6CC (id_tarif_id), INDEX IDX_399C9EF73A8EB775 (id_user_admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
