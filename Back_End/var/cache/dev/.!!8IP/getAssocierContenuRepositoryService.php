 ...
 */
class getAssocierContenuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssocierContenuRepository' shared autowired service.
     *
     * @return \App\Repository\AssocierContenuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssocierContenuRepository.php';

        return $container->privates['App\\Repository\\AssocierContenuRepository'] = new \App\Repository\AssocierContenuRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
