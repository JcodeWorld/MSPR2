...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\ContactController', 'App\\Controller\\ContenuPageController', 'App\\Controller\\TarifPageController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $j = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, ['enable_max_depth' => true]);
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $e, $m, $f, $h, $l, $n, $container->parameters['api_platform.serializer.default_context'], $g, NULL);
        ...
        $r = new \ApiPlatform\Serializer\ItemNormalizer($c, $d, $e, $m, $h, $l, $n, NULL, $b, $g, [], NULL);
        ...
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $t, $h, $a, $u, NULL, ['enable_max_depth' => true], $a);
        $w = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, ['enable_max_depth' => true]);

        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($h), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $l), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $l, $container->parameters['api_platform.serializer.default_context']), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($k, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $l), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $m, $q, $l, $container->parameters['api_platform.serializer.default_context'], true), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $e, $q), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $l), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, ['enable_max_depth' => true], $s), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($o, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(['enable_max_depth' => true], $t), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $t, $a, $u, NULL, ['enable_max_depth' => true])), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($s, ['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, ['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $m, $e, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $h, 1, $container->parameters['api_platform.serializer.default_context']), $b, $m, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $e, $f), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($v, $i, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($j, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($w, $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(['enable_max_depth' => true]), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $i, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $i, 'default')], ['enable_max_depth' => true]), $i, 'default');
    }
