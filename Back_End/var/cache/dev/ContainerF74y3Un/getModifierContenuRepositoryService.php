 ...
 */
class getModifierContenuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModifierContenuRepository' shared autowired service.
     *
     * @return \App\Repository\ModifierContenuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModifierContenuRepository.php';

        return $container->privates['App\\Repository\\ModifierContenuRepository'] = new \App\Repository\ModifierContenuRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
