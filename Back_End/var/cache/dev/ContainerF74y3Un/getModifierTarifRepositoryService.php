 ...
 */
class getModifierTarifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModifierTarifRepository' shared autowired service.
     *
     * @return \App\Repository\ModifierTarifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModifierTarifRepository.php';

        return $container->privates['App\\Repository\\ModifierTarifRepository'] = new \App\Repository\ModifierTarifRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
