 ...
 */
class getAssocierTarifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssocierTarifRepository' shared autowired service.
     *
     * @return \App\Repository\AssocierTarifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssocierTarifRepository.php';

        return $container->privates['App\\Repository\\AssocierTarifRepository'] = new \App\Repository\AssocierTarifRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
