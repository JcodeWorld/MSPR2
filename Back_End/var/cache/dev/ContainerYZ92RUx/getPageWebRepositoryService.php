 ...
 */
class getPageWebRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PageWebRepository' shared autowired service.
     *
     * @return \App\Repository\PageWebRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PageWebRepository.php';

        return $container->privates['App\\Repository\\PageWebRepository'] = new \App\Repository\PageWebRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
