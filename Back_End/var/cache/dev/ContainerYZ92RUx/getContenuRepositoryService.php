 ...
 */
class getContenuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContenuRepository' shared autowired service.
     *
     * @return \App\Repository\ContenuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContenuRepository.php';

        return $container->privates['App\\Repository\\ContenuRepository'] = new \App\Repository\ContenuRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
